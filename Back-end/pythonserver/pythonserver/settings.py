...
SECRET_KEY = 'django-insecure-l&f#=sk0kiy-%g(!y+1v0ll==@!1d!wve)dpiv0@2^@qgodd7q'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['70.12.130.121','127.0.0.1']
...
CORS_ALLOW_ALL_ORIGINS = False  # 모든 도메인에서 요청을 허용하지 않음
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",  # 허용할 도메인 목록에 추가
    "http://localhost:8080",
]
