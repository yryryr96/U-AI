  ...
  return (
    <>
      <Canvas style={isLoading ? {visibility: "hidden"} : {visibility:"visible"}} orthographic camera={{ zoom: 5, position: [0, 0, 200], far: 300, near: 50 }}>
        <Scene />
        <CharacterScene position={[82, -55, 0]} width={200} height={200} gifUrl='/resources/policepanda3.gif' />
        <CharacterScene position={[-115, -55, 0]} width={240} height={240} gifUrl='/resources/teacherpanda2.gif' />
        <Effects />
      </Canvas>
